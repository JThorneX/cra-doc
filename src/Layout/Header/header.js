        ...
        <div className="banner w-lg-75 mx-lg-auto position-relative px-lg-3 py-4 shadow-5 rounded-3 rounded-lg-pill">
          <nav className="navbar navbar-expand-lg p-0">
            <div className="container">
              <a className="btn d-inline-block w-lg-64 p-2 fs-4 px-4" href="/">
                Home
              </a>
              <div className="collapse navbar-collapse justify-content-end ">
                <div className="navbar-nav align-items-lg-center gap-2 ms-lg-4 w-lg-6">
                  <a className="btn bg-dark-hover border-0 w-100 w-lg-auto mb-4 mb-lg-0 p-2 fs-4 px-44">
                    Login
                  </a>{" "}
                  <br />
                  <a className="btn bg-dark-hover border-0 w-100 w-lg-auto mb-4 mb-lg-0 p-2 fs-4 px-4">
                    Register
                  </a>
                </div>
              </div>
